                ...
                <div>
                  ...
                  <ul className="disc text-[17px] mt-3 leading-8">
                    ...
                    <li>
                      <h3 className="">HSC</h3>
                      <p>
                        Hsc passed from Maharashtra board in the year 2018. With
                        an aggregate 51%
                      </p>
                    </li>
                    <li>
                      <h3 className="">SSC</h3>
                      <p>
                        SSC passed from Maharashtra board in the year 2016. With
                        an aggregate 70%
                      </p>
                    </li>
                  </ul>
          ...
          <div className="mt-5">
            ...
            <div className="">
              ...
              <p>
                ...
                Services to customers. role and responsibilities are to optimize
                and develop the company's official website on both front end and
                backend, Website custom design, developing planning and
                executing that process as well, ensuring that your new website
                is optimized for search engines and designed with your customers
                in mind.
              </p>
              <p>
            ...
            <div className="">
              ...
              <p>
                <b>Job profile :- </b>
                Jewel Webnet is part of oriflamme IT Solutions which offers web
                solutions for jewelry and other businesses. I am responsible for
                developing the website of the company, as well as front end
                designing and backend structure of the website, planning, and
                executing it, as well as making sure the new site is
                SEO-optimized and built with user experience in mind.
              </p>
              <p>
                Page layout design for database integration in SQL, Website blog
                page design, newsletter popup, Ebooks Download integration,
                Landing Pages and Product page design for an online store.
                Creating a custom eCommerce website. Developing custom themes
                and plugins, CSS styling and HTML coding. Responsive design for
